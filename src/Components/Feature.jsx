  ...
  const features = [
    {
      ...
      description:
        "Empowering students through a value-based and skill-oriented academic environment for holistic development.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Smart classrooms equipped with modern technology for interactive learning.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Highly qualified teachers with international teaching experience.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "State-of-the-art sports complex for holistic development of students.",
    },
  ];
